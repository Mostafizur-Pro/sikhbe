    ...
    return (
      ...
      >
		...
		toggle.addEventListener('click', () => {
		  ...
		  if (body.classNameList.contains('text-gray-900')) {
			toggle.innerHTML = "☀️";
			body.classNameList.remove('text-gray-900');
			body.classNameList.add('text-gray-100');
			profile.classNameList.remove('bg-white');
			profile.classNameList.add('bg-gray-900');
		  } else
		  {
			toggle.innerHTML = "🌙";
			body.classNameList.remove('text-gray-100');
			body.classNameList.add('text-gray-900');
			profile.classNameList.remove('bg-gray-900');			
			profile.classNameList.add('bg-white');
