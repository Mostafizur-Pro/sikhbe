    ...
    <div>
      <div className="text-center py-10">
        ...
        <div className="my-10 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mx-auto max-w-7xl px-5">
          ...
          <p className="btn bg-[#563d7c] text-white hover:bg-[#59287a] font-bold text-lg border-none rounded-md transition-transform duration-300 ease-in-out hover:scale-105">
            Bootstrap
          </p>
          <p className="btn bg-[#11b3d2] text-white hover:bg-[#11b3d2] font-bold text-lg border-none rounded-md transition-transform duration-300 ease-in-out hover:scale-105">
            Tailwind
          </p>
          <p className="btn bg-[#1fd1aa] text-white hover:bg-[#1fd1aa] font-bold text-lg border-none rounded-md transition-transform duration-300 ease-in-out hover:scale-105">
            DaisyUI
          </p>
          ...
          <p className="btn bg-[#f5711b] font-bold text-lg border-none text-white rounded-md hover:bg-[#f5711b] hover:scale-105 transition-transform duration-300 ease-in-out">
            Mongoose
          </p>
        </div>
      </div>
