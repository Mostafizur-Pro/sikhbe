        ...
        <div className="join join-vertical ">
          ...
          <div className="collapse collapse-arrow join-item border border-[#b154f0] mb-5">
            ...
            <div className="collapse-content text-2xl text-white text-justify">
              <p className="m-3">
                ...
                করতে পারবেন। পরীক্ষার সময় ২-৩টি অ্যাসাইনমেন্ট দেরিতে জমা দিলেও
                SCIC থেকে বাদ পড়বেন না। আমাদের স্টুডেন্ট কেয়ার টিম আপনাকে রুটিন
                বানাতে এবং গাইডলাইন দিয়ে সাহায্য করবে।
              </p>
            </div>
          </div>
          {/* FAQ Item 3 */}
          ...
          <div className="collapse collapse-arrow join-item border border-[#b154f0] mb-5">
            ...
            <div className="collapse-content text-2xl text-white text-justify">
              <p className="m-3">
                ...
                আপনাকে ভার্সিটির পড়ালেখার সাথে সামঞ্জস্য রেখে কাজ করতে হবে। কিছু
          ...
          <div className="collapse collapse-arrow join-item border border-[#b154f0] mb-5">
            ...
            <div className="collapse-content text-2xl text-white text-justify">
              <p className="m-3">
                ...
                বেকার, প্রেমিক, এমনকি ফোন ধরে না এমন প্রেমিকা হলেও এই কোর্স করতে
                পারবেন।
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow join-item border border-[#b154f0] mb-5">
            ...
            <div className="collapse-content text-2xl text-white text-justify">
              <p className="m-3">
                ...
                দেখতে হবে। প্রতিদিন ডেডিকেটেড সময় রাখতে হবে এবং সেই সময়ের মধ্যে
                ভিডিওগুলো দেখতে হবে।
              </p>
            </div>
          </div>
          ...
          <div className="collapse collapse-arrow join-item border border-[#b154f0] mb-5">
            ...
            <div className="collapse-content text-2xl text-white text-justify">
              <p className="m-3">
                {/* <hr className="my-5" /> */}
                আপনার যে কোনো প্রশ্ন web@programming-hero.com এ পাঠিয়ে দিন। আমরা
                ২৪ ঘন্টার মধ্যে উত্তর দেবো।
              </p>
            </div>
          </div>
          {/* FAQ Item 15 */}
          ...
          <div className="collapse collapse-arrow join-item border border-[#b154f0] mb-5">
            ...
            <div className="collapse-content text-2xl text-white text-justify">
              <p className="m-3">
                ...
                আপনি যেকোনো সমস্যার সমাধান পাবেন। এছাড়াও, স্ক্রিনশেয়ার করে আপনার
          ...
          <div className="collapse collapse-arrow join-item border border-[#b154f0] mb-5">
            ...
            <div className="collapse-content text-2xl text-white text-justify">
              <p className="m-3">
                ...
                জানেন তারাও অনেক কিছু শিখতে পারবেন। বিশেষ করে যারা নিজেদের স্কিল
                আপগ্রেড করতে চান, তাদের জন্যও এই কোর্সটি উপযুক্ত।
              </p>
            </div>
          </div>
        </div>
